...
export default function Documents() {
  ...
  // TODO Phase 1E: Enable full UI once S3 storage and download endpoint are implemented
  const COMING_SOON = true
  if (COMING_SOON) {
    return (
      <ComingSoon
        title="Documents"
        description="Secure document storage with S3 download links will be available after the automated pipeline (Phase 1E). Documents generated by Yaksh — invoice data, GSTR-1 JSONs, acknowledgments — will appear here automatically."
        phase="1E"
      />
    )
  }
